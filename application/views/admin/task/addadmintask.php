                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <form action="<?php echo site_url('admin/admin_task/toadd_admintask') ?>"  enctype="multipart/form-data" method="post">
                        <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
							...
							<div class="col-lg-3">
								...
								<input class="form-control" name="ad[ProblemSummary]"  value="<?php echo isset($task['ProblemSummary'])?$task['ProblemSummary']:'';?>">
							</div>  
							<div class="col-lg-3">
								<label>Person Reported:</label>
								<input class="form-control" name="ad[PersonReported]"  value="<?php echo isset($task['PersonReported'])?$task['PersonReported']:'';?>">
							</div>
							<div class="col-lg-3">
								<label>Scource:</label>
								<select class="form-control" name="ad[Source]">
							...
							<div class="col-lg-3">
								...
								<select class="form-control" name="ad[AssignTo]">
							...
							<div class="col-lg-3">
								...
								<select class="form-control"  name="ad[ProdState]">
