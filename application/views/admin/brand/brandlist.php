			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                           <a href="<?php echo site_url('admin/brand/addbrand');?>"><input type="button"  value="ADD BRAND"/></a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
							       ...
							       <?php
									...
									<tr>
										...
										<td>
										<a href="<?php echo site_url('admin/brand/addbrand') ?>?bid=<?php  echo isset($brand[$i]['bid']) ?$brand[$i]['bid']:'';?>">edit</a>
