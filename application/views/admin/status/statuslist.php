                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <div class="panel-heading">
                           <a href="<?php echo site_url('admin/status/addstatus');?>"><input type="button"  value="ADD STATUS"/></a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tr>
										...
										<td><a href="<?php echo site_url('admin/status/addstatus') ?>?sid=<?php  echo isset($status[$i]['sid']) ?$status[$i]['sid']:'';?>">edit</a> 
