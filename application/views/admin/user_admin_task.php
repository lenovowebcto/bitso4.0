...
<body>
    <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">LOIS User_Admin Task List</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						   ...
						   <tr><td colspan='8'>NO Data</td></tr>
							...
							?>
							<tr>
								<td><a href="<?php echo site_url('admin/admin_task/add_admintask')?>?t_id=<?php echo isset($list[$i]['Ticket_id'])?$list[$i]['Ticket_id']:'';?>"><?php echo isset($list[$i]['Ticket_id']) ?$list[$i]['Ticket_id']:'';?></a></td>
