                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <?php if(isset($tpg) && count($tpg)>0){
                                    	...
                                    	?>
                                    	 <tr class="odd gradeX">
                                    	  <td><a href="<?php echo site_url('task/addtask/task')?>?pr_id=1&id=<?php echo isset($val['id'])?$val['id']:0;?>">
                                            <?php echo $key+1;?></a></td>
                                            ...
                                            <td class="center"><?php if(isset($val['complete_date']) && $val['complete_date']!='0000-00-00'){echo $val['complete_date'];}?></td>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                    ...
                                    <?php if(isset($optlist) && count($optlist)>0){
                                    	...
                                    	?>
                                    	 ...
                                    	 <tr class="odd gradeX">
                                            <td><a href="<?php echo site_url('opt/opt_create_task/task')?>?pr_id=2&optid=<?php echo isset($val['OPTID'])?$val['OPTID']:0;?>">
                                            <?php echo $key+1;?></a></td>
                                            
                                             <td><?php if(isset($val['OPT_AD']) && $val['OPT_AD']!='0000-00-00'){echo $val['OPT_AD'];}?></td>
                                           <!--  
                                           <?php echo isset($val['OPT_AD'])?$val['OPT_AD']:'';?>
                                   ...
                                   <thead>
                                    ...
                                    <?php if(isset($svclist) && count($svclist)>0){
                                    	...
                                    	?>
                                    	 ...
                                    	 <tr class="odd gradeX">
                                    	 <td><a href="<?php echo site_url('opt/opt_create_task/task')?>?pr_id=2&svcid=<?php echo isset($val['SVCID'])?$val['SVCID']:0;?>">
                                            <?php echo $key+1;?></a></td>
                                          ...
                                          <td><?php if(isset($val['EOW']) && $val['EOW']!='0000-00-00'){echo $val['EOW'];}?></td>
                                           ...
                                           <!--  <td><?php echo isset($val['Deadline'])?$val['Deadline']:'';?></td>
                                            <td><?php echo isset($val['EOW'])?$val['EOW']:'';?></td> -->
                                    ...
                                    <?php if(isset($eplist) && count($eplist)>0){
                                    	...
                                    	?>
                                    	 ...
                                    	 <tr class="odd gradeX">
                                            ...
                                            <!-- <td><?php echo isset($val['Deadline'])?$val['Deadline']:'';?></td>
                                            <td><?php echo isset($val['RequestDate'])?$val['RequestDate']:'';?></td> -->
                                    	...
                                    	?>
                                    	 ...
                                    	 <tr class="odd gradeX">
                                    	  <td><a href="<?php echo site_url('element/ele_task/addeletask')?>?pr_id=3&pid=<?php echo isset($val['pid'])?$val['pid']:0;?>"><?php echo $key+1;?></a></td>
                                           ...
                                           <!--  <td><?php echo isset($val['AD'])?$val['AD']:'';?></td>
                                            <td><?php echo isset($val['DeadLine'])?$val['DeadLine']:'';?></td> -->
