   <!-- Bootstrap Core JavaScript -->
    ...
    <link href="<?php  echo base_url();?>util/bitso/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">
    <link href="<?php  echo base_url();?>util/bitso/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" media="all" href="<?php  echo base_url();?>util/bitso/bower_components/daterangepicker/daterangepicker-bs3.css" />
	...
	<link href="<?php  echo base_url();?>util/bitso/css/BeatPicker.min.css" rel="stylesheet">
