...
BeatPicker.prototype={dateInputNode:null,pickerNode:null,daysSimple:"Su Mo Tu We Th Fr Sa".split(" "),daysFull:[],monthsSimple:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),monthsFull:"January February March April May June July August September October November December".split(" "),startDate:new Date,currentDate:new Date,dateFormat:{separator:"/",format:["YYYY","MM","DD"]},modules:{header:!0,footer:!0,daysOfTheWeek:!0,navBar:!0,today:!0,gotoDate:!0,icon:!0},selectionRule:{single:!0,
...
view:{display:"days",alwaysVisible:!1,position:["bottom","left"],showOn:"click",hideOn:"click",isInputIsReadonly:!0},
